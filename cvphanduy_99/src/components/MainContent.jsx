      ...
      <div className="space-y-6">
        ...
        <section>
          ...
          <p className="text-gray-700">
            ...
            reactjs. Em khá tự tin về khả năng và quyết tâm theo nghề IT này.
            Tuy em không phải xuất thân là dân lập trình, Nhưng sau 1 năm theo
            học, em cảm thấy mình khá tự tin về nền tảng lập trình của mình.em
            mong anh/chị tuyển dụng cân nhắc và cho em một cơ hội thực tập tại
            doanh nghiệp. Em hứa sẽ cố gắng học hỏi và đáp ứng yêu cầu công
            việc. Em xin chân thành cảm ơn ạ!.
          </p>
        </section>
        ...
        <section>
          ...
          <div className="border-l-4 border-teal-600 pl-4">
            ...
            <p className="text-gray-600">
              ...
              <br />
              Đang chuẩn bị học ngôn ngữ JAVA
            </p>
          </div>
        </section>
        ...
        <section>
          ...
          <div className="grid gap-4">
            <div className="border-l-4 border-teal-600 pl-4">
              <h3 className="font-semibold text-lg">
                Website cá nhân quản lý đơn hàng
              </h3>
              <p className="text-gray-700">
              ...
              <a
                href="https://mounage-anlr.vercel.app"
                target="_blank"
            ...
            <div className="border-l-4 border-teal-600 pl-4">
              ...
              <p className="text-gray-700">
                Xây dựng website CV cá nhân sử dụng React và Tailwind CSS với
                các tính năng trang home, shop, detail, giỏ hàng, và đăng kí và
                đăng nhập
              </p>
              <a
                href="https://shopdienthoai.vercel.app/"
                target="_blank"
                rel="noopener noreferrer"
                className="text-blue-500  underline hover:no-underline"
              >
